...
def get_down_block(
    ...
    elif down_block_type == "CrossAttnDownRemoveSelfAttnBlock2D":
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for CrossAttnDownRemoveSelfAttnBlock2D")
        return CrossAttnDownRemoveSelfAttnBlock2D(
            num_layers=num_layers,
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            out_channels=out_channels,
...
def get_mid_block(
    ...
    elif mid_block_type == "UNetMidBlock2DCrossAttnWoResBlock":
        return UNetMidBlock2DCrossAttnWoResBlock(
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            out_channels=out_channels,
            temb_channels=temb_channels,
...
def get_up_block(
    ...
    elif up_block_type == "UpBlockUpSampleFirst2D":
        return UpBlockUpSampleFirst2D(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            prev_output_channel=prev_output_channel,
    ...
    elif up_block_type == "CrossAttnUpRemoveSelfAttnBlock2DV1": # upsample after res, transfomrer block
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for CrossAttnUpRemoveSelfAttnBlock2DV1")
        return CrossAttnUpRemoveSelfAttnBlock2DV1(
            num_layers=num_layers,
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            out_channels=out_channels,
    ...
    elif up_block_type == "CrossAttnUpRemoveSelfAttnBlock2D":
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for CrossAttnUpRemoveSelfAttnBlock2D")
        return CrossAttnUpRemoveSelfAttnBlock2D(
            num_layers=num_layers,
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            out_channels=out_channels,
...
class UNetMidBlock2D(nn.Module):
    ...
    Args:
        ...
        use_sep_conv (`bool`, *optional*, defaults to `False`): Whether to use separable convolutions in resnet block.
...
class UNetMidBlock2DCrossAttnWoResBlock(nn.Module):
    def __init__(
        self,
        in_channels: int,
        temb_channels: int,
...
class CrossAttnDownBlock2D(nn.Module):
    def __init__(
        ...
        for i in range(num_layers):
            ...
            if not dual_cross_attention:
                # print(f'in crossAtt_with_sa...{i}:{num_kv_heads}')
                attentions.append(
                    Transformer2DModel(
                        num_attention_heads,
                        out_channels // num_attention_heads,
...
class CrossAttnDownRemoveSelfAttnBlock2D(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class CrossAttnUpRemoveSelfAttnBlock2DV1(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class CrossAttnUpRemoveSelfAttnBlock2D(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class UpBlockUpSampleFirst2D(nn.Module):
    def __init__(
        self,
        in_channels: int,
        prev_output_channel: int,
